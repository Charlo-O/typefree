...
const EN_US: Record<string, string> = {
  ...
  "controlPanel.greeting.night": "Working late?",
  "controlPanel.greeting.morning": "Good morning",
  "controlPanel.greeting.noon": "Good afternoon",
  "controlPanel.greeting.afternoon": "Good afternoon",
  "controlPanel.greeting.evening": "Good evening",
  "controlPanel.stats.daysUsed": "Days used",
  "controlPanel.stats.sessions": "Transcriptions",
  "controlPanel.stats.characters": "Total characters",
  "controlPanel.stats.savedTime": "Time saved",
  "controlPanel.stats.usage": "Usage",
  "controlPanel.stats.recentWindow": "Past 26 weeks",
  "controlPanel.stats.totalInput": "{count} characters",
  "controlPanel.statUnit.days": "days",
  "controlPanel.statUnit.times": "times",
  "controlPanel.statUnit.characters": "chars",
  "controlPanel.statUnit.seconds": "sec",
  "controlPanel.statUnit.minutes": "min",
  "controlPanel.statUnit.hours": "hr",
  ...
  "vocabulary.add": "Add",
  "vocabulary.saveHotword": "Save hotword",
  "vocabulary.cancel": "Cancel",
  "vocabulary.save": "Save",
  "vocabulary.sort.time": "Sort by time added",
  "vocabulary.sort.alpha": "Sort alphabetically",
  "vocabulary.bulkEdit": "Bulk Edit",
  "vocabulary.hotwords.bulkPlaceholder": "One hotword per line. Saving replaces custom hotwords.",
  ...
  "vocabulary.addTrigger": "Add...",
  "vocabulary.global": "Global",
  "vocabulary.editGroup": "Edit replacement",
  "vocabulary.removeGroup": "Remove group",
  "vocabulary.snippets.empty": "No custom snippets yet. Add one above.",
  "vocabulary.snippets.bulkPlaceholder":
    "One group per line: Replacement, trigger 1, trigger 2, ...",
  "vocabulary.importSnippets": "Import replacements",
  "vocabulary.bulkHotwords.title": "Bulk Edit Hotwords",
  "vocabulary.bulkHotwords.desc": "One hotword per line. Saving replaces all custom hotwords.",
  "vocabulary.hotwordCount": "{count} hotwords",
  "vocabulary.bulkSnippets.title": "Bulk Edit Snippets",
  "vocabulary.bulkSnippets.desc":
    "Use the Type4Me format: replacement first, then every misrecognized trigger.",
  "vocabulary.snippetGroupCount": "{count} replacement groups",
  "vocabulary.quick.open": "Quick Correction",
  "vocabulary.quick.title": "Correction",
  "vocabulary.quick.desc":
    "Select the misrecognized characters, enter the correct word, and add a snippet.",
  "vocabulary.quick.sourcePlaceholder": "Paste or pick recognized text...",
  "vocabulary.quick.select": "Tap or drag to select misrecognized characters",
  "vocabulary.smart.open": "Smart Correction",
  "vocabulary.smart.title": "Tell me what was misrecognized",
  "vocabulary.smart.desc":
    "Generate snippet variants and hotword suggestions from one correction example.",
  "vocabulary.history": "History",
  "vocabulary.history.empty": "No history records",
  "vocabulary.correctWord": "Correct word",
  "vocabulary.correctWord.placeholder": "Type the correct word...",
  "vocabulary.expectedWord": "Word you expected",
  "vocabulary.expectedWord.placeholder": "Claude Code",
  "vocabulary.actualWord": "Word actually recognized",
  "vocabulary.actualWord.placeholder": "cloud code",
  "vocabulary.generateVariants": "Generate Variants",
  "vocabulary.snippetSuggestions": "Snippet Suggestions",
  "vocabulary.hotwordSuggestions": "Hotword Suggestions",
  "vocabulary.selectAll": "Select All",
  "vocabulary.exists": "Exists",
  "vocabulary.noSnippetSuggestions": "No snippet suggestions generated",
  "vocabulary.noHotwordSuggestions": "No hotword suggestions",
  "vocabulary.backToEdit": "Back to Edit",
  "vocabulary.addSelected": "Add Selected ({count})",
...
const ZH_CN: Record<string, string> = {
  ...
  "controlPanel.greeting.night": "夜深了",
  "controlPanel.greeting.morning": "早上好",
  "controlPanel.greeting.noon": "中午好",
  "controlPanel.greeting.afternoon": "下午好",
  "controlPanel.greeting.evening": "晚上好",
  "controlPanel.stats.daysUsed": "已经使用",
  "controlPanel.stats.sessions": "发起会话",
  "controlPanel.stats.characters": "总输入字数",
  "controlPanel.stats.savedTime": "节省时间",
  "controlPanel.stats.usage": "使用统计",
  "controlPanel.stats.recentWindow": "过去 26 周",
  "controlPanel.stats.totalInput": "共输入 {count} 字",
  "controlPanel.statUnit.days": "天",
  "controlPanel.statUnit.times": "次",
  "controlPanel.statUnit.characters": "字",
  "controlPanel.statUnit.seconds": "秒",
  "controlPanel.statUnit.minutes": "分钟",
  "controlPanel.statUnit.hours": "小时",
  ...
  "vocabulary.add": "添加",
  "vocabulary.saveHotword": "保存热词",
  "vocabulary.cancel": "取消",
  "vocabulary.save": "保存",
  "vocabulary.sort.time": "按添加时间排序",
  "vocabulary.sort.alpha": "按字母排序",
  "vocabulary.bulkEdit": "批量编辑",
  "vocabulary.hotwords.bulkPlaceholder": "每行一个热词。保存后会覆盖所有自定义热词。",
  ...
  "vocabulary.addTrigger": "添加...",
  "vocabulary.global": "全局生效",
  "vocabulary.editGroup": "编辑替换词",
  "vocabulary.removeGroup": "移除整组",
  "vocabulary.snippets.empty": "还没有自定义片段替换，从上方添加。",
  "vocabulary.snippets.bulkPlaceholder": "每行一组：替换词, 触发词1, 触发词2, ...",
  "vocabulary.importSnippets": "导入替换",
  "vocabulary.bulkHotwords.title": "批量编辑热词",
  "vocabulary.bulkHotwords.desc": "每行一个热词。保存后会覆盖所有自定义热词。",
  "vocabulary.hotwordCount": "{count} 个热词",
  "vocabulary.bulkSnippets.title": "批量编辑片段替换",
  "vocabulary.bulkSnippets.desc": "使用 Type4Me 格式：先写替换词，后面写所有误识别触发词。",
  "vocabulary.snippetGroupCount": "{count} 组替换规则",
  "vocabulary.quick.open": "快速纠错",
  "vocabulary.quick.title": "纠错",
  "vocabulary.quick.desc": "选择误识别的字，输入正确词，然后添加片段替换。",
  "vocabulary.quick.sourcePlaceholder": "粘贴或从历史选择识别文本...",
  "vocabulary.quick.select": "点击或拖选误识别的字符",
  "vocabulary.smart.open": "智能纠错",
  "vocabulary.smart.title": "告诉我哪里识别错了",
  "vocabulary.smart.desc": "根据一次纠错示例生成片段变体和热词建议。",
  "vocabulary.history": "历史记录",
  "vocabulary.history.empty": "暂无历史记录",
  "vocabulary.correctWord": "正确的词",
  "vocabulary.correctWord.placeholder": "输入正确的词...",
  "vocabulary.expectedWord": "你希望识别出的词",
  "vocabulary.expectedWord.placeholder": "Claude Code",
  "vocabulary.actualWord": "实际识别出的词",
  "vocabulary.actualWord.placeholder": "cloud code",
  "vocabulary.generateVariants": "生成变体",
  "vocabulary.snippetSuggestions": "片段替换建议",
  "vocabulary.hotwordSuggestions": "热词建议",
  "vocabulary.selectAll": "全选",
  "vocabulary.exists": "已存在",
  "vocabulary.noSnippetSuggestions": "没有生成片段建议",
  "vocabulary.noHotwordSuggestions": "没有热词建议",
  "vocabulary.backToEdit": "返回修改",
  "vocabulary.addSelected": "添加选中项（{count}）",
  ...
  "settings.recordingAudio.muteSystemAudioHelp": "录音期间静音扬声器和耳机，录完后恢复之前的状态。",
